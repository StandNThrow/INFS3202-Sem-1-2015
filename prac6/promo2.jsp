...
<%
    ...
    String selectQuery = "SELECT * FROM MyPromotions WHERE promoID = 2";
    String commentsQuery = "SELECT comments FROM MyComments WHERE promoID = 2";
...
%>
    ...
    <script type="text/javascript">
        ...
        function addComments() {
            ...
            var comjson = '{"comments":{"promoID":"2", "comment":"'+com+'"}}';
        ...
        function addComments2() {
            ...
            var objJSON = '{"comments":{"promoID":"2", "comment":"'+com+'"}}';
