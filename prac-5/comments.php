			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					if ($sessionUsername == 0) {
						...
						<li><p class="navbar-text">Welcome back, <a class="navbar-link"><?php echo $_SESSION["username"]; ?></a></p></li>
						<?php } ?>
					</ul>
				</div>
			</div>
				...
				<div class="col-lg-7">
					<div class="panel panel-default">
						...
						<form name="formAddComment" id="formAddComment" method="POST">
							...
							<div class="form-group">
								<label for="placeComments">Add New Comment: <span style="color:red;">(Please enter more than 10 characters to prevent spam)</span></label>
